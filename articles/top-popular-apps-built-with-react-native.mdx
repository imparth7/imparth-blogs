...
<BannerImage src="./../images/top-popular-apps-built-with-react-native.png" alt="Top Popular Apps Built With React Native Banner" title="Top Popular Apps Built With React Native" />
